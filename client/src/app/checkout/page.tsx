        ...
        <div className="min-h-screen bg-white px-4 py-6 md:px-8 md:py-10">
            <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[minmax(0,1.5fr)_minmax(320px,0.9fr)]">
                <Card>
                    <CardContent>
                        <CardHeader>
                            <CardTitle className="text-3xl font-black tracking-tight text-[#2a1b14]">
                                Checkout
                            </CardTitle>
                            <CardDescription>
                                Review your shipping details before placing the
                                order.
                            </CardDescription>
                        </CardHeader>
                ...
                <Card>
                    <CardContent className="space-y-6 px-6 pb-6 md:px-8 md:pb-8">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Your current cart and final amount.
                            </CardDescription>
                        </CardHeader>
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-lg font-bold text-[#2a1b14]">
                                Total
                            </span>
                        ...
                        <Button
                            asChild
                            variant="ghost"
                            className="w-full text-base text-muted-foreground hover:bg-transparent hover:text-[#2a1b14]"
                        >
                            <Link
                                href="/"
